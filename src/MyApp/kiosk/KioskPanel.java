...
public class KioskPanel {
	...
	private void initialize() {
		...
		JButton btnSummit_1 = new JButton("Summit");
		GridBagConstraints gbc_btnSummit_1 = new GridBagConstraints();
		gbc_btnSummit_1.insets = new Insets(0, 0, 5, 0);
		gbc_btnSummit_1.gridx = 3;
		gbc_btnSummit_1.gridy = 5;
		panel.add(btnSummit_1, gbc_btnSummit_1);
